    ...
    <section className="relative w-full h-[70vh] md:h-[620px] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex items-center justify-center md:justify-start px-4">
        <div className="max-w-7xl mx-auto w-full">
          <div className="max-w-2xl text-center md:text-left mx-auto md:mx-0 md:mb-25">
            <h1
              data-aos="fade-up"
              data-aos-duration="1000"
              className="text-[26px] md:text-[40px] font-semibold text-secondary mb-4"
            >
            ...
            <p
              ...
              data-aos-duration="1000"
              data-aos-delay="200"
              className="text-gray-600 mb-8 xl-para md:max-w-[70%] mx-auto md:mx-0"
            >
            ...
            <div
              ...
              data-aos-duration="1000"
              data-aos-delay="300"
              className="backdrop-blur-md bg-white/70 rounded-xl px-6 md:px-11 py-5 flex flex-col md:flex-row gap-6 md:gap-10 w-fit mx-auto md:mx-0 items-center"
            >
              {/* Stat 1 */}
              <div
                data-aos="fade-up"
              ...
              <div
                ...
                data-aos-duration="1000"
                data-aos-delay="500"
                className="hidden md:block h-16 w-px bg-gray-300"
              ></div>
